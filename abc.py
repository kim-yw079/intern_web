...
class TestVm(models.Model):
    ...
    publicip = models.CharField(db_column='publicIP', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Vmlisttest0121(models.Model):
    ...
    vm_pk = models.IntegerField(primary_key=True)
    ip2 = models.CharField(db_column='IP2', max_length=30, blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'vmlisttest0121'
